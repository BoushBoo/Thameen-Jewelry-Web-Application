...
<body>
        ...
        ?>
                    <div class="product-details">
                        ...
                        <div class="product-info">
                            ...
                            <p>Subtotal: <?php echo $product['price'] * $item['quantity']; ?> SAR</p>
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="quantity-update-form" onsubmit="return validateQuantity();">
                                ...
                                <input type="number" name="quantity" id="quantity" value="<?php echo $item['quantity']; ?>" min="1" max="<?php echo $product['stock']; ?>" data-max-stock="<?php echo $product['stock']; ?>">
    ...
    <div class="total-section">
        <h2>Total Amount: <?php echo calculateTotal(); ?> SAR</h2>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
